...
public class CoursesTable {
	...
	public static final String SELECT_COUNT_FOR_SPRING_COURSES = SELECT_COUNT + " WHERE " + SEMESTERS_COLUMN + " LIKE '%Spring%'";

	public static final String SELECT_COUNT_FOR_SUMMER_COURSES = SELECT_COUNT + " WHERE " + SEMESTERS_COLUMN + " LIKE '%Summer%'";
}
